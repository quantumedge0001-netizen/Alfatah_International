      ...
      <AreaChart data={data} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
        <defs>
          <linearGradient id="salesFill" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#1f7a68" stopOpacity={0.35} />
            <stop offset="100%" stopColor="#1f7a68" stopOpacity={0} />
          </linearGradient>
        </defs>
        ...
        />
        <Area type="monotone" dataKey="total" stroke="#1f7a68" strokeWidth={2} fill="url(#salesFill)" />
      </AreaChart>
    </ResponsiveContainer>
  );
}